...
interface CurrentWeatherProps {
    data:WeatherData,
    locationNames?:GeocodingResponse
}

const CurrentWeather = ({data,locationNames}:CurrentWeatherProps) => {
                    ...
                    <div className="space-y-4">
                        <div className="space-y-2">
                            <div className="flex items-center">
                                <h2 className="text-2xl font-bold tracking-tight"> {locationNames?.name}</h2>
                                {
                                    locationNames?.state && (
