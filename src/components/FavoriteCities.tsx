...
function FavoriteCityTablet({id,name,lat,lon,onRemove}:FavoriteCitiesProps) {
    ...
    return (
        <div
            ...
            role="button"
            tabIndex={0}
            className="relative flex min-w-[250px] cursor-pointer items-center gap-3 rounden-lg border bg-card p-4 pr-8 shadow-sm transition-all hover:shadow-md"
        >
            <Button
                onClick={(e)=>{
                    e.stopPropagation()
